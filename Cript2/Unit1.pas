...
begin
    Timer1.Enabled := True;
    EndeCriptFile(editArquivoOrigem.Text , editArquivoOrigem.Text + 'EndCript.txt'  , '1');
...
begin
    Timer2.Enabled := True;
    EndeCriptFile(editArquivoOrigem.Text + 'EndCript.txt' ,editArquivoOrigem.Text + 'Descript.txt', '1');
