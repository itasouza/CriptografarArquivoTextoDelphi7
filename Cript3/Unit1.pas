...
begin
    Timer1.Enabled := True;
    EndeCriptFile(editArquivoOrigem.Text , editArquivoOrigem.Text + 'EndCript.txt'  , '256');
...
begin
    Timer2.Enabled := True;
    EndeCriptFile(editArquivoOrigem.Text + 'EndCript.txt' ,editArquivoOrigem.Text + 'Descript.txt', '256');
...
begin
  lbTempo.Caption := TimeToStr(Time);
  Application.ProcessMessages;
end;

procedure TForm1.Timer2Timer(Sender: TObject);
begin
  lbTempoDes.Caption := TimeToStr(Time);
  Application.ProcessMessages;
end;
